            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body" style="background-color: #fff;">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-4">
                        <li class="nav-item">
                            <h5><a href="" onclick="sessionValid()" class="nav-link" class="btn ms-5" disabled style="color: #3F83F8;">Session History</a></h5>
                        </li>
                        <button onclick="addValid()" type="button" class="btn btn-primary" disabled data-bs-toggle="button">
                            Add Table
                        </button>
                    </ul>
                </div>
